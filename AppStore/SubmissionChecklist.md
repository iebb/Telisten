...
- Complete export-compliance answers for Telegram MTProto encryption. These are legal declarations and are intentionally not pre-answered here.
...
- Use an internal TestFlight group containing only Account Holder and Admin users.
- Do not create an external testing group or public link.
