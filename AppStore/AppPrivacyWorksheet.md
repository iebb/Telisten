...
- chat and audio requests needed to browse, search, stream, download, react, reply, forward, and manage the `_Playlist` folder;
- reactions, comments, forwarded messages, new private playlist channels, and folder changes that the user explicitly creates.
